 ...
 */
export const WEDDING_DATE = dayjs.tz("2026-05-23 13:00", "Asia/Seoul")
...
// 신부 정보 설정
export const BRIDE_FULLNAME = "문혜원"
export const BRIDE_FIRSTNAME = "혜원"
export const BRIDE_TITLE = "장녀"
export const BRIDE_FATHER = "문동주"
export const BRIDE_MOTHER = "정순진"
...
// 신랑 정보 설정
export const GROOM_FULLNAME = "김래선"
export const GROOM_FIRSTNAME = "래선"
export const GROOM_TITLE = "장남"
export const GROOM_FATHER = "김화복"
export const GROOM_MOTHER = "양혜숙"
